...
extern "C" {
	...
	MY_DLL_EXPORT void MyCefStringHolder_Read(MyCefStringHolder* mycefstr, char16_t* outputBuffer, int outputBufferLen, int* actualLength);
	MY_DLL_EXPORT void MyCefStringGetRawPtr(void* cefstring, char16_t** outputBuffer, int* actualLength);
	...
	MY_DLL_EXPORT MyCefStringHolder* MyCefCreateStringHolder(const wchar_t* str,int len);
	MY_DLL_EXPORT MyCefBufferHolder* MyCefCreateBufferHolder(int len);
	MY_DLL_EXPORT MyCefBufferHolder* MyCefCreateBufferHolderWithInitData(int len,char* data);
	//----------
