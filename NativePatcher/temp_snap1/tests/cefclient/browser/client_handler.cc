//###_ORIGINAL D:\projects\cef_binary_3.3071.1647.win32\tests\cefclient\browser//client_handler.cc
  ...
  // Provide the GTK-based dialog implementation on Linux.
	...
	void ClientHandler::OnProtocolExecution(CefRefPtr<CefBrowser> browser,
		...
		if (this->mcallback_)
		{
			...
			//allow_os_execution = (args.result0.value.i32 == 1);
	...
	bool ClientHandler::OnCertificateError(CefRefPtr<CefBrowser> browser,
		...
		if (cert.get()) {
			...
			if (this->mcallback_)
			{
				...
				//auto str16 = GetCertificateInformation(cert, ssl_info->GetCertStatus());
