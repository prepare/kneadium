//---THIS-FILE-IS-PATCHED , org=D:\projects\cef_binary_3.3071.1647.win32\cpptoc\v8interceptor_cpptoc.cc
...
namespace {
	...
	int CEF_CALLBACK v8interceptor_get_byname(struct _cef_v8interceptor_t* self,
		...
		//	CefV8InterceptorExt::GetBynameArgs args1(tmp_arg1, object, retval, tmp_arg4);
	...
	int CEF_CALLBACK v8interceptor_get_byindex(struct _cef_v8interceptor_t* self,
		...
		//if (m_callback) {
		//	CefString tmp_arg4(exception);
		//	CefV8InterceptorExt::GetByindexArgs args1(index, object, retval, tmp_arg4);
		//	m_callback(CALLER_CODE, &args1.arg);
		//	if (((args1.arg.myext_flags >> 21) & 1) == 1) {
		//		return args1.arg.myext_ret_value;
		//	}
