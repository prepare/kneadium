//---THIS-FILE-IS-PATCHED , org=D:\projects\cef_binary_3.3071.1647.win32\cpptoc\render_handler_cpptoc.cc
...
namespace {
	...
	int CEF_CALLBACK
		...
		auto m_callback = me->GetManagedCallBack(CALLER_CODE);
		if (m_callback) {
			CefRenderHandlerExt::GetScreenPointArgs args1(browser, viewX, viewY, screenX, screenY);
			m_callback(CALLER_CODE, &args1.arg);
			if (((args1.arg.myext_flags >> 21) & 1) == 1) {
				return args1.arg.myext_ret_value;
			}
