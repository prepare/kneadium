//MIT, 2017, WinterDev
 ...
 namespace CefV8InterceptorExt
 {
	 ...
	 const int CefV8InterceptorExt_get_byname_1 = 1;
	 const int CefV8InterceptorExt_get_byindex_2 = 2;
	 const int CefV8InterceptorExt_set_byname_3 = 3;
	 const int CefV8InterceptorExt_set_byindex_4 = 4;
