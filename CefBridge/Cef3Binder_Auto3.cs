...
namespace LayoutFarm.CefBridge.Auto
{
    ...
    class MyCefAccessibilityHandler
    {
    ...
    class MyCefBrowserProcessHandler
    {
    ...
    class MyCefRenderProcessHandler
    {
    ...
    class MyCefRequestContextHandler
    {
    ...
    class MyCefResourceBundleHandler
    {
